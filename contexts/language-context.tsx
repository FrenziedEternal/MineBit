...
const translations = {
  th: {
    ...
    "terms.term4.content":
      "ลูกค้าที่ซื้อผลิตภัณฑ์เวอร์ชันก่อนหน้า มีสิทธิ์ขอรับการอัปเดตเวอร์ชันใหม่ไ��้โดยไม่เสียค่าใช้จ่าย ยกเว้นกรณีที่ผลิตภัณฑ์มีการเปลี่ยนแปลงอย่างมีนัยสำคัญ ซึ่งอาจมีค่าใช้จ่ายเพิ่มเติม",
    ...
    "terms.term6.content":
      "เงื่อนไขอื่นๆ ที่นอกเหนือจากที่ระบุไว้ข้างต้น จะมีการชี้แจงเพิ่มเติมตามความเหมาะสมของแต่ละสถานการณ์ เพื่อให้เกิดความเป็นธรรมกับท���้งผู้ให้บริการและผู้ใช้บริการทุกฝ่าย",
